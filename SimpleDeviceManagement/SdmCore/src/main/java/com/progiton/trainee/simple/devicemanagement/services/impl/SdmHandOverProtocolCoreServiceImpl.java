...
@Service
public class SdmHandOverProtocolCoreServiceImpl implements SdmHandOverProtocolCoreService {
	...
	public  SdmHandOverProtocolCoreServiceImpl(SdmHandOverProtocolRepository sdmHandOverProtocolRepository,
	...
	public SdmHandOverProtocolTo confirmByDeviceSerialNumber(String serialNumber) {
		...
		SdmHandOverProtocolEntity protocolToConfirm = sdmHandOverProtocolRepository
				.findByDevice_SerialNumberAndIsConfirmedFalse(serialNumber);

		if (protocolToConfirm == null) {
			throw new SdmEntityNotFoundException(
					"No non-confirmed handover protocols found for device: " + serialNumber);
		}
		...
		SdmActionType actionType = protocolToConfirm.getActionType();
