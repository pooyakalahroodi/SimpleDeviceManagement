...
import com.progiton.trainee.simple.devicemanagement.services.impl.SdmDeviceCoreServiceImpl;

@ExtendWith(MockitoExtension.class)
class SdmDeviceCoreServiceImplTest {
	...
	@InjectMocks
	private SdmDeviceCoreServiceImpl deviceService;
