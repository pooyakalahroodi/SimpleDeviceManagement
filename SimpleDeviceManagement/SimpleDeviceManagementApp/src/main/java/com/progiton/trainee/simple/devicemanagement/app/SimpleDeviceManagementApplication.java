...
@EnableJpaRepositories(basePackages = "com.progiton.trainee.simple.devicemanagement.repositories")
@SpringBootApplication(scanBasePackages = {
    "com.progiton.trainee.simple.devicemanagement"})
@EnableJpaAuditing
@ComponentScan(basePackages = "com.progiton.trainee")
@EntityScan(basePackages = "com.progiton.trainee.simple.devicemanagement.model")
